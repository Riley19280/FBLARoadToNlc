...
svcutil.exe http://localhost:9617/YardSaleService.svc?wsdl /d:E:\Documents\GitHub\Secret-Project\App\GarageSale\GarageSale\GarageSale /async /edb /mergeConfig
