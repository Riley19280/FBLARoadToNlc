...
namespace yardSaleWCF
{
	public class myDataTypes
	{
		...
		{
			public itemWCF(int id, string owner_id, string name, string description, string pic_url, float price, float quality, bool sold, DateTime date_added, string bidder_id, string bid_amount)
			{
				this.id = id;
			...
			public string bid_amount { get; protected set; }
		}
